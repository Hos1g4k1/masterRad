...
\begin{figure}[h]
    ...
    \caption{Komunikacija veb aplikacije aplikacije i operativnog sistema}
...
Smanjene performanse: Zbog dodatnog sloja apstrakcije i oslanjanja na web tehnologije, performanse hibridnih aplikacija mogu biti lošije u odnosu na native aplikacije, posebno za zahtevne zadatke.
Kompromis u korisničkom iskustvu: Iako se trude da imitiraju izgled i osećaj native aplikacija, hibridne aplikacije često ne mogu potpuno replicirati fluidnost i odziv native sučelja.
Zavisnost od trećih strana: Hibridne aplikacije zavise od platformi kao što su Cordova ili Ionic, što može dovesti do problema ako se ti alati ne ažuriraju redovno ili ne podržavaju najnovije verzije operativnih sistema.
